...
public class BookingValidation {
    ...
    public static String createStateForBooker(String str) {
        return createState(str, "_BOOKER");
    }

    public static String createStateForOwner(String str) {
        return createState(str, "_OWNER");
    }

    private static String createState(String str, String userType) {
