...
public class UserNotAllowedAccessBookingExceptionTest {


    private UserNotAllowedAccessBookingException exception;


    @BeforeEach
    public void create() {
        exception = new UserNotAllowedAccessBookingException("test message");
