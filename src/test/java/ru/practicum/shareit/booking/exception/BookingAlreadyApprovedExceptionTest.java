...
public class BookingAlreadyApprovedExceptionTest {


    private BookingAlreadyApprovedException exception;


    @BeforeEach
    public void create() {
        exception = new BookingAlreadyApprovedException("test message");
